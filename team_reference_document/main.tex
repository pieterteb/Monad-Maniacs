...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\includegraphics[height=1.2cm]{University-of-amsterdam-3012137660.jpg}} % Replace with your image
\fancyhead[R]{\thepage}
...
% Minted settings
\setminted{fontsize=\footnotesize,breaklines=true,linenos=false}

% Custom environment to keep a function together on one page
...
\begin{titlepage}
    ...
    % Image
    \includegraphics[width=0.75\textwidth]{universiteit-van-amsterdam-logo-png-transparent-2300688522.png} % replace with your image
    
    \vspace{1cm} % space between image and names
    
    % Names
    {\Large Monad Maniacs \par}
    
    \vspace*{\fill} % fill the rest of the page vertically
\end{titlepage}

% Example usage: multiple functions, each kept together
\begin{keepfunction}
